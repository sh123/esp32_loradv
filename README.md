...
It functions like a standard FM walkie-talkie and, for simplicity and traffic optimization, does not utilize any communication protocol. Instead, it transmits audio codec frames using pre-configured digital radio modulation. There are ideas to add voice over ax.25 and perhaps m17 protocol support in the future.
