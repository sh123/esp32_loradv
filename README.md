...
In theory, it could also be used with other modules from `E22-xxxM30S` series with compatible pinouts, such as `E22-868M30S/E22-900M30S` (SX1262) modules (UHF, 868/915 MHz) or `E22-170M33S`/`E22-220M30S`, but not tested.
